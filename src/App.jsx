...
{ id: 'hsbc_elite', name: { zh: '滙豐 卓越尊尚', en: 'HSBC Premier Elite' }, stockCode: '0005', domain: 'www.hsbc.com.hk', url: 'https://www.hsbc.com.hk/zh-hk/accounts/offers/deposits/', rates: { HKD: { '3m': 2.2, '6m': 2.0, '12m': null } }, minDeposit: 10000, type: 'trad', conditions: { zh: '新資金優惠', en: 'New Funds' }, color: 'bg-rose-600' },
  ...
  { id: 'bocom_hk_pref', name: { zh: '交通銀行 優息定存', en: 'Bank of Comm' }, stockCode: '3328', domain: 'www.hk.bankcomm.com', url: 'https://www.hk.bankcomm.com/hk/shtml/hk/en/2005742/2005763/2005764/list.shtml', rates: { HKD: { '3m': 0.275, '6m': 0.275, '12m': 0.3 } }, minDeposit: 500000, type: 'trad', conditions: { zh: '50萬以上', en: '500k+' }, color: 'bg-blue-800' },
