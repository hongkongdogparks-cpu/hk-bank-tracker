...
import {
  ...
  RefreshCw, WifiOff, Loader2, Clock, Activity, Database
} from 'lucide-react';
...
const T = {
  zh_TW: {
    ...
    notAvailable: '暫無提供', loading: '連接雲端數據中…', updated: '更新於', syncing: '實時監控中'
  },
  en: {
...
const INITIAL_BANKS = [
  ...
  { id: 'hsbc_one', name: '滙豐 HSBC One / 一般', stockCode: '0005', domain: 'hsbc.com.hk', url: 'https://www.hsbc.com.hk/zh-hk/accounts/offers/deposits/', rates: {}, minDeposit: 10000, type: 'trad', offer: '網上優惠', color: 'bg-red-50 text-red-700 border border-red-100' },
  
  { id: 'hangseng_prestige', name: '恒生 優越理財', stockCode: '0011', domain: 'hangseng.com', url: 'https://www.hangseng.com/zh-hk/personal/banking/rates/deposit-interest-rates/', rates: {}, minDeposit: 1000000, type: 'trad', offer: '特優利率', color: 'bg-green-800 text-white' },
  { id: 'hangseng_standard', name: '恒生 一般帳戶', stockCode: '0011', domain: 'hangseng.com', url: 'https://www.hangseng.com/zh-hk/personal/banking/rates/deposit-interest-rates/', rates: {}, minDeposit: 10000, type: 'trad', offer: '一般優惠', color: 'bg-green-100 text-green-800 border border-green-200' },
  
  { id: 'boc_wealth', name: '中銀理財', stockCode: '2388', domain: 'bochk.com', url: 'https://www.bochk.com/zh/deposits/promotions/timedeposit.html', rates: {}, minDeposit: 1000000, type: 'trad', offer: '理財晉級', color: 'bg-red-800 text-white' },
  { id: 'boc_standard', name: '中銀 一般客戶', stockCode: '2388', domain: 'bochk.com', url: 'https://www.bochk.com/zh/deposits/promotions/timedeposit.html', rates: {}, minDeposit: 10000, type: 'trad', offer: '手機銀行', color: 'bg-red-50 text-red-700 border border-red-100' },
  
  { id: 'citi_gold', name: '花旗 Citigold', stockCode: 'US:C', domain: 'citibank.com.hk', url: 'https://www.citibank.com.hk/zh/banking/time-deposit.html', rates: {}, minDeposit: 50000, type: 'trad', offer: '特惠利率', color: 'bg-blue-700 text-white shadow-lg' },
  { id: 'citi_plus', name: '花旗 Citi Plus', stockCode: 'US:C', domain: 'citibank.com.hk', url: 'https://www.citibank.com.hk/zh/banking/time-deposit.html', rates: {}, minDeposit: 10000, type: 'trad', offer: '數碼優惠', color: 'bg-blue-500 text-white' },
  
  { id: 'sc_priority', name: '渣打 優先理財', stockCode: '2888', domain: 'sc.com', url: 'https://www.sc.com/hk/zh/save/time-deposits/', rates: {}, minDeposit: 1000000, type: 'trad', offer: '優先理財', color: 'bg-blue-800 text-white' },
  { id: 'sc_standard', name: '渣打 網上特惠', stockCode: '2888', domain: 'sc.com', url: 'https://www.sc.com/hk/zh/save/time-deposits/', rates: {}, minDeposit: 10000, type: 'trad', offer: '網上特惠', color: 'bg-blue-50 text-blue-700 border border-blue-100' },
  
  { id: 'bea_supreme', name: '東亞 至尊理財', stockCode: '0023', domain: 'hkbea.com', url: 'https://www.hkbea.com/html/zh/bea-personal-banking-deposit-time-deposit-offers.html', rates: {}, minDeposit: 100000, type: 'trad', offer: '至尊理財', color: 'bg-red-800 text-white' },
  { id: 'icbc_elite', name: '工銀亞洲 理財金', stockCode: '1398', domain: 'icbcasia.com', url: 'https://www.icbcasia.com/tc/personal/deposits/index.html', rates: {}, minDeposit: 100000, type: 'trad', offer: '理財尊享', color: 'bg-red-700 text-white' },
  { id: 'ccb_prestige', name: '建行亞洲 貴賓理財', stockCode: '0939', domain: 'asia.ccb.com', url: 'https://www.asia.ccb.com/hongkong_tc/personal/banking/deposits/index.html', rates: {}, minDeposit: 1000000, type: 'trad', offer: '貴賓尊享', color: 'bg-blue-900 text-white' },
  { id: 'public_online', name: '大眾銀行 網上定存', stockCode: '0626', domain: 'publicbank.com.hk', url: 'https://www.publicbank.com.hk/zh-hant/personalbanking/deposits/timedeposit', rates: {}, minDeposit: 10000, type: 'trad', offer: '網上優惠', color: 'bg-red-50 text-red-800 border border-red-100' },

  // --- 虛擬銀行 ---
  { id: 'za', name: 'ZA Bank (眾安)', stockCode: 'VB01', domain: 'za.group', url: 'https://bank.za.group/hk/deposit', rates: {}, minDeposit: 1, type: 'virt', offer: '不限資金', color: 'bg-teal-50 text-teal-800 border border-teal-100' },
  { id: 'paob', name: '平安壹賬通', stockCode: 'VB05', domain: 'paob.com.hk', url: 'https://www.paob.com.hk/tc/deposit.html', rates: {}, minDeposit: 100, type: 'virt', offer: '保證回報', color: 'bg-orange-50 text-orange-800 border border-orange-100' },
  { id: 'fusion', name: '富融銀行 (Fusion)', stockCode: 'VB02', domain: 'fusionbank.com', url: 'https://www.fusionbank.com/', rates: {}, minDeposit: 1, type: 'virt', offer: '靈活存', color: 'bg-purple-50 text-purple-800 border border-purple-100' },
  { id: 'livi', name: 'Livi Bank', stockCode: 'VB03', domain: 'livibank.com', url: 'https://www.livibank.com/', rates: {}, minDeposit: 1, type: 'virt', offer: 'liviSave', color: 'bg-blue-50 text-blue-800 border border-blue-100' },
              ...
              <div key={bank.id} className={`bg-white rounded-[2.5rem] border border-slate-200 p-8 md:p-10 flex flex-wrap items-center justify-between gap-8 transition-all ${belowMin ? 'opacity-40 grayscale pointer-events-none' : 'hover:shadow-2xl hover:-translate-y-1 group'}`}>
                <div className="flex items-center gap-8 min-w-0">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap gap-2 pt-1">
                      ...
                      <span className="text-[10px] text-slate-400 font-bold bg-slate-50 px-2 py-1 rounded-full uppercase border border-slate-100">Min: HK${bank.minDeposit.toLocaleString()}</span>
                ...
                <div className="flex items-center gap-12 ml-auto">
                  <div className="text-right">
                    ...
                    <p className={`text-5xl font-black tabular-nums leading-none tracking-tighter ${hasR ? 'text-slate-900' : 'text-slate-100'}`}>{hasR ? `${r.toFixed(2)}%` : t.notAvailable}</p>
                  </div>
